...
describe('Typeset', () => {
    ...
    it('should process a complex text', () => {
        const html = '<p>Yjarni Sigurðardóttir spoke to NATO from Iceland yesterday: "Light of my  life, fire of my florins -- my sin, my soul. The tip of the tongue taking a trip to 118° 19\' 43.5"."</p>' +
