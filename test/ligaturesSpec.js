...
describe('Ligatures', () => {
    ...
    it('should replace (fi) by (ﬁ)', () => {
        const html = '<p>A file folder (US usage) (or folder in British and Australian usage) is a kind of folder that holds loose papers</p>';
    ...
    it('should replace (fl) by (ﬂ)', () => {
        const html = '<p>fluency is a speech language pathology term that means the smoothness or flow with which sounds</p>';
