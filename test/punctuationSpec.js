...
describe('Punctuation', () => {
    ...
    it('should replace three dots by elipses symbol on texts with multiple matches', () => {
        const html = '<p>En un lugar de la mancha... De cuyo nombre no quiero acordarme... no ha mucho tiempo que vivía...</p>';
    ...
    it('should replace two dashes (--) by a dash (–)', () => {
        const html = '<p>Pues aquí hay algo que no te va a gustar Laura, --dijo Carlos-- yo también voy al equipo de Juan.</p>';
    ...
    it('should replace a dash between spaces ( – ) by (&thinsp;&mdash;&thinsp;)', () => {
        const html = '<p>Use an "en" dash to con­nect num­bers in a range. It means "up to and includ­ing" when used like this: "During the years 1998 – 1999," and "peo­ple aged 55 – 63."</p>';
